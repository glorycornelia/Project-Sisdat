<?php
    ...
    $sqlGet = "SELECT * FROM harga WHERE Tipe_Harga='$Tipe_Harga'";
...
<body>
    <div class="main">
        ...
        <div class="w-50 mx-auto border p-3 mt-5">
            <div class="content">
                <h1>Tambahkan Data Harga</h1>
                <form action="editharga.php" method="post">
                    <label for="Tipe_Harga">Tipe Harga</label>
                    <input type="text" id="Tipe_Harga" name="Tipe_Harga" value="<?php echo "$data[Tipe_Harga]"?>" class="form-control" readonly>
                    <label for="Waktu">Waktu (Hari)</label>
                    <input type="text" id="Waktu" name="Waktu" value="<?php echo "$data[Waktu]"?>" class="form-control">
                    <label for="Harga">Harga</label>
                    <input type="text" id="Harga" name="Harga" value="<?php echo "$data[Harga]"?>" class="form-control">
        ...
        <?php
            if (isset($_POST['submit'])) {
                ...
                $sqlUpdate = "UPDATE harga SET Waktu='$Waktu', Harga='$Harga' WHERE Tipe_Harga='$Tipe_Harga'";
